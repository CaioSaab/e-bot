  ...
  <div class="p-6 text-white max-w-7xl mx-auto">
    ...
    <div v-if="produtos.length" class="grid gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
      <div
        ...
        :key="item.id"
        class="bg-gray-800 p-4 rounded-xl shadow-lg flex flex-col"
      >
        ...
        <div class="mt-auto flex gap-3">
          <button
            ...
            class="flex-1 bg-yellow-500 hover:bg-yellow-600 transition rounded-md px-4 py-2 text-white font-semibold"
          >
            Editar
          </button>
          <button
            @click="excluirProduto(item.id)"
            class="flex-1 bg-red-600 hover:bg-red-700 transition rounded-md px-4 py-2 text-white font-semibold"
          >
            Excluir
          </button>
        </div>
        ...
        >
          ...
          <div class="flex justify-end gap-4 mt-6">
            <button
              ...
              class="px-5 py-2 rounded-md bg-gray-300 text-gray-700 font-semibold hover:bg-gray-400 transition"
            >
              Cancelar
            </button>
            <button
          ...
          <button
            ...
            aria-label="Fechar"
            class="absolute top-3 right-3 text-gray-500 hover:text-gray-800 transition text-2xl font-bold"
          >
            &times;
          </button>
        </div>
    ...
    <button
      @click="toggleFormulario"
      class="fixed bottom-6 right-6 bg-green-600 hover:bg-green-700 text-white text-4xl font-bold px-5 py-2 rounded-full shadow-lg flex items-center justify-center"
